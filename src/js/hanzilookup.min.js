...
HanziLookup.AnalyzedCharacter = function (r) {
    ...
    function t(r) {
        for (var t = 0; t != r.length; ++t)
            for (var n = 0; n != r[t].length; ++n) {
                var a = r[t][n];
                a[0] < E && (E = a[0]), a[0] > c && (c = a[0]), a[1] < M && (M = a[1]), a[1] > l && (l = a[1])
            }
    }
    ...
    function u(r) {
        ...
        for (var h = n(r[u], r[e]), i = h, a = 2; a < r.length; ++a) {
            ...
            var E = n(r[o], M),
                c = n(r[u], M);
            (h > f * E || i > s * c) && (t[o] && n(r[o], r[e]) < v && (t[o] = !1), t[e] = !0, i = l, u = e), h = l, o = e, e = a
        }
    ...
    function h(r, t) {
        for (var n = [], u = 0, h = 0; h != t.length; ++h) {
            ...
            if (i != u) {
                ...
                f = Math.round(255 * f);
                var s = e(r[u], r[i]);
                s[0] = Math.round(15 * s[0]), s[1] = Math.round(15 * s[1]), n.push(new HanziLookup.SubStroke(v, f, s[0], s[1])), u = i
            }
        }
        return n
    }
    ...
    var v = 12.5,
        ...
        p = [],
        N = 0;
    t(r), i(r), this.top = M <= 256 ? M : 0, this.bottom = l >= 0 ? l : 256, this.left = E <= 256 ? E : 0, this.right = c >= 0 ? c : 256, this.analyzedStrokes = p, this.subStrokeCount = N
};
var HanziLookup = HanziLookup || {};
    ...
    function v(t) {
        ...
        if (h > 0) {
            ...
            var F = Math.sqrt(i * i / 4 - h),
                ...
                X = u / (3 * r) * -1;
            n.push(2 * H * Math.cos(L / 3) - u / (3 * r)), n.push(q * (x + N) + X), n.push(q * (x - N) + X)
        }
        return n
    }
    var w = t,
...
HanziLookup.decodeCompact = function (r) {
    "use strict";
    for (var e = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", t = new Uint8Array(256), a = 0; a < e.length; a++) t[e.charCodeAt(a)] = a;
    var a, n, o, h, c, A = .75 * r.length,
        d = r.length,
        i = 0;
    "=" === r[r.length - 1] && (A--, "=" === r[r.length - 2] && A--);
    var u = new ArrayBuffer(A),
        C = new Uint8Array(u);
    for (a = 0; a < d; a += 4) n = t[r.charCodeAt(a)], o = t[r.charCodeAt(a + 1)], h = t[r.charCodeAt(a + 2)], c = t[r.charCodeAt(a + 3)], C[i++] = n << 2 | o >> 4, C[i++] = (15 & o) << 4 | h >> 2, C[i++] = (3 & h) << 6 | 63 & c;
    return C
};
var HanziLookup = HanziLookup || {};
HanziLookup.DrawingBoard = function (e, t) {
    ...
    function n() {
        h.clearRect(0, 0, h.canvas.width, h.canvas.height), h.setLineDash([1, 1]), h.lineWidth = .5, h.strokeStyle = "grey", h.beginPath(), h.moveTo(0, 0), h.lineTo(h.canvas.width, 0), h.lineTo(h.canvas.width, h.canvas.height), h.lineTo(0, h.canvas.height), h.lineTo(0, 0), h.stroke(), h.beginPath(), h.moveTo(0, 0), h.lineTo(h.canvas.width, h.canvas.height), h.stroke(), h.beginPath(), h.moveTo(h.canvas.width, 0), h.lineTo(0, h.canvas.height), h.stroke(), h.beginPath(), h.moveTo(h.canvas.width / 2, 0), h.lineTo(h.canvas.width / 2, h.canvas.height), h.stroke(), h.beginPath(), h.moveTo(0, h.canvas.height / 2), h.lineTo(h.canvas.width, h.canvas.height / 2), h.stroke()
    }

    function o(e, t) {
        u = !0, T = [], f = [e, t], T.push(f), h.strokeStyle = "grey", h.setLineDash([]), h.lineWidth = c, h.beginPath(), h.moveTo(e, t), l = new Date
    }
    ...
    function a(e, t) {
        u = !1, e != -1 && (h.lineTo(e, t), h.stroke(), T.push([e, t]), d.push(T), T = [], g && g())
    }

    function s() {
        for (var e in d) {
            h.strokeStyle = "grey", h.setLineDash([]), h.lineWidth = c, h.beginPath(), h.moveTo(d[e][0][0], d[e][0][1]);
            for (var t = d[e].length, n = 0; n < t - 1; n++) h.lineTo(d[e][n][0], d[e][n][1]), h.stroke();
        ...
        if (m) {
            if (S && (h.strokeStyle = "blue", h.setLineDash([1, 1]), h.lineWidth = .5, h.beginPath(), h.moveTo(m.left, m.top), h.lineTo(m.right, m.top), h.stroke(), h.lineTo(m.right, m.bottom), h.stroke(), h.lineTo(m.left, m.bottom), h.stroke(), h.lineTo(m.left, m.top), h.stroke()), b)
                for (var o = 0; o != m.xStrokes.length; ++o) {
                    ...
                    for (var a = 1; a < i.length; ++a) h.lineTo(i[a][0], i[a][1]), h.stroke(), h.beginPath(), h.arc(i[a][0], i[a][1], 3, 0, 2 * Math.PI, !0), h.fillStyle = "red", h.fill()
                }
            if (y && m.yStrokes)
            ...
            if (m.zStrokes)
                for (var o = 0; o != m.zStrokes.length; ++o) {
                    ...
                    for (var a = 1; a < i.length; ++a) h.lineTo(i[a][0], i[a][1]), h.stroke(), h.beginPath(), h.arc(i[a][0], i[a][1], 3, 0, 2 * Math.PI, !0), h.fillStyle = "green", h.fill()
                }
        }
    }
    var r, h, l, f, v = e,
        ...
        S = !1,
        y = !1;
    return r = $('<canvas class="stroke-input-canvas" width="256" height="256"></canvas>'), v.append(r), h = r[0].getContext("2d"), r.mousemove(function (e) {
        if (u) {
...
var HanziLookup = HanziLookup || {};
HanziLookup.data = {}, HanziLookup.init = function (a, o, t) {
    "use strict";

    function n(a, o) {
        HanziLookup.data[a] = JSON.parse(o), HanziLookup.data[a].substrokes = HanziLookup.decodeCompact(HanziLookup.data[a].substrokes)
    }
    var e = new XMLHttpRequest;
    e.open("GET", o, !0), e.onreadystatechange = function () {
        4 === this.readyState && (200 === this.status ? (n(a, e.responseText), t(!0)) : t(!1))
    }, e.send()
};
var HanziLookup = HanziLookup || {};
...
var HanziLookup = HanziLookup || {};
HanziLookup.MAX_CHARACTER_STROKE_COUNT = 48, HanziLookup.MAX_CHARACTER_SUB_STROKE_COUNT = 64, HanziLookup.DEFAULT_LOOSENESS = .15, HanziLookup.AVG_SUBSTROKE_LENGTH = .33, HanziLookup.SKIP_PENALTY_MULTIPLIER = 1.75, HanziLookup.CORRECT_NUM_STROKES_BONUS = .1, HanziLookup.CORRECT_NUM_STROKES_CAP = 10, HanziLookup.Matcher = function (o, n) {
    "use strict";
...
HanziLookup.StrokeInputOverlay = function (t, o, i, s, h, r, e) {
    "use strict";
    this.top = t, this.right = o, this.bottom = i, this.left = s, this.xStrokes = h, this.yStrokes = r, this.zStrokes = e
};
var HanziLookup = HanziLookup || {};
HanziLookup.SubStroke = function (t, i, n, o) {
    "use strict";
    this.direction = t, this.length = i, this.centerX = n, this.centerY = o
};
